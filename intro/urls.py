...
urlpatterns = [
    ...
    path('get_products/<str:start_date>/<str:end_date>/', views.get_products, name='get_products'),
    ...
    path('get_products_stars/<str:start_date>/<str:end_date>/', views.get_products_stars, name='get_products_stars'),
